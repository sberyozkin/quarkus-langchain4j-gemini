...
public interface PersonalAssistantService {
    @SystemMessage("""
            ...
            Your tasks are:
             ...
             - Get the list of the available calendars and ask the user which calendar the user would like to check and remember the user's choice.
             - Use the calendar id field as a calendarId value
