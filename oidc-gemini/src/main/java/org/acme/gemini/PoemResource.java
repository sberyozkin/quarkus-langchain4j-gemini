...
public class PoemResource {
    ...
    static final String USER_MESSAGE = """
            Write a short 1 paragraph poem dedicated to one of the currently logged in user's calendar event time zones.
    ...
    @RegisterAiService(tools = { PoemTools.class, GoogleCalendarClient.class})
